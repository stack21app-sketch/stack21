-- Migración para Agente AI con planes, límites y facturación
...
CREATE TRIGGER IF NOT EXISTS update_usage_counters_updated_at 
  BEFORE UPDATE ON public.usage_counters
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER IF NOT EXISTS update_org_faqs_updated_at 
