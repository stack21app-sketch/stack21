...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/dashboard')) {
    ...
    if (token) {
      console.log('✅ NextAuth token found, allowing access to dashboard')
    } else {
  ...
  // Protect API routes (except auth, public health, and login)
  ...
  // Rate limiting - TEMPORALMENTE DESHABILITADO PARA PRUEBAS
  ...
  // Solo aplicar cabeceras de seguridad fuertes en producción (evita forzar HTTPS en localhost)
